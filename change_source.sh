...
sudo apt install -y devscripts git-buildpackage pristine-tar vim neofetch git fakeroot build-essential libncurses-dev xz-utils libssl-dev bc flex libelf-dev bison gpg python3-pyquery wget make gcc dpkg-dev python3-pip python3-tk